...
public class Main1780 {
  ...
  static void check(int x, int y, int size) {
    ...
    if (size == 1) {
      if (board[x][y] == -1) {
        count1++;
        // System.out.println("size가 1입니다. count1을 올립니다 >> count1 : " + count1 + ", count2 : " +
        // count2 + ", count3 : " + count3);
      } else if (board[x][y] == 0) {
        count2++;
        // System.out.println("size가 1입니다. count2을 올립니다 >> count1 : " + count1 + ", count2 : " +
        // count2 + ", count3 : " + count3);
      } else {
        count3++;
        // System.out.println("size가 1입니다. count3을 올립니다 >> count1 : " + count1 + ", count2 : " +
        // count2 + ", count3 : " + count3);
      }
      return;
    }
