...
public class Indentation {
  ...
  public Indentation() {
    ...
    /* 메소드 호출 부문 줄바꿈 방식 */
    someNumber1 =
        someMethod1(argNumber1, argNumber2, argNumber3, argNumber4, argNumber5, argNumber6);
    someNumber2 =
        someMethod1(
            argNumber1,
            argNumber2,
    ...
    someNumber1 =
        argNumber1
            + argNumber2 * (argNumber3 + argNumber4 - argNumber5)
            + 4 * argNumber4
            + argNumber5; // 선호되는 방식

    someNumber2 =
        argNumber2
            + argNumber1 * (argNumber3 + argNumber4 - argNumber5)
            + 4 * argNumber4
            + argNumber5; // 피해야 하는 방식
  ...
  /* 메소드 선언 부문 줄바꿈 방식 */
  int someMethod1(
      int argument1, int argument2, int argument3, int argument4, int argument5, int argument6) {
