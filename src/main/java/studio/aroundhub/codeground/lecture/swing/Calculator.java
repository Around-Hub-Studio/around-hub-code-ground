...
public class Calculator extends JFrame {
  ...
  private void setEvents() {
    ...
    buttonDevide.addActionListener(
        e -> {
          calculate("/");
        });
    ...
    buttonMultiple.addActionListener(
        e -> {
          calculate("X");
        });
